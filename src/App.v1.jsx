...
export default function App() {
	...
	const Spinner = () => {
		return (
			<Box>
				<Box paddingBottom={2}>
					<Typography textAlign={'center'}>The AI is thinking</Typography>
				</Box>
	...
	if (showInprogress) {
		return (
			...
			>
				<Box paddingBottom={2}>
					<Typography textAlign={'center'}>AI is processing your question</Typography>
				</Box>
				<CircularProgress value={25} />
			</Box>)
	}
			...
			>
				<Paper elevation={2} sx={{ margin: '1rem', padding: '1rem', minWidth: isLargeScreen ? 400 : '80%' }}>
					...
					<Box sx={{ paddingTop: 2, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }} >
						<Button variant="contained" size='large' onClick={restart} disabled={similarQuestionAnswer != null ? false : true}>Home</Button>
			...
			<Box>
				...
				>
					<Box sx={{
						...
						{questionLatex && showSolutionOptions && <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 1 }}>
